...
$sql1 = "UPDATE jeuActive SET ordreActuel='".$ordreSuivant."',
ordreSuivant=NULL,nbrErreur=0,currentScore=0 WHERE id=".$id." AND theme='".$theme."';";
$res1 = mysqli_query($conn,$sql1);
...
<body style="background-image: linear-gradient(yellow, red);">
    <div class="logo">
        <a href="../home/home.php" style="text-decoration:none;">Game Card</a>
    </div>
    ...
    <div class="p" style="text-align:center;font-style:italic;margin-bottom:10px">
        ...
        <br>
        Vous avez fait <?php echo $nbrErreur;?> erreurs!
