...
<center>
<div class="endBack">
        <a href="jeu-principal.php" style="text-decoration:none;margin-top:10px;">MENU</a>
    </div></center>
        ...
        <div class="card">
            <div class="face face1">
                <div class="content">
                    ...
                    <input type="radio" value="<?php echo $prop1; ?>" name="prop">
                    <label for="<?php echo $prop1; ?>"><?php echo $prop1; ?></label> <br>
                    
                    <input type="radio" value="<?php echo $prop2; ?>" name="prop">
                    <label for="<?php echo $prop2; ?>"><?php echo $prop2; ?></label> <br>
                    
                    <input type="radio" value="<?php echo $prop3; ?>" name="prop">
